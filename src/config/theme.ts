...
export const labMembers: LabMember[] = [
  ...
  { id: 'patricia-machado', initials: 'PM', color: 'from-nebula-cyan/30 to-nebula-violet/20', role: 'partner', lab: 'unirio', photo: '/imagens/membros/patricia.jpeg', lattes: 'http://lattes.cnpq.br/5349549779631011' },
